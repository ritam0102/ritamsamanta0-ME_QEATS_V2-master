...
public class RestaurantServiceMockitoTestStub {
  ...
  public void initializeRestaurantObjects() throws IOException {
    ...
    // Assigning the array elements to the protected variables for use in tests
  ...
  public void testFindNearbyWithin5km() throws IOException {
    // FIX: Use 5.0 as the radius because 3:00 AM is off-peak (radius is 5.0km)
    // If the mock expects 1.0 but the service sends 5.0, it returns null.
  ...
  public void testFindNearbyWithin3km() throws IOException {
    // Initialize lists based on the requirement of the final assertions
